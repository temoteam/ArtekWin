...
namespace Artek.Pages
{
    public sealed partial class ShellPage : Page
    {
        ...
        private void InitializeNavigationItems()
        {
            ...
            NavigationItems.Add(AppNavigation.NodeFromAction(
				"86093d11-9cf2-4b39-885a-fb647acd0d06",
                "Новости",                
                AppNavigation.ActionFromPage("Section1ListPage"),
				AppNavigation.IconFromGlyph("\ue14c")));

            NavigationItems.Add(AppNavigation.NodeFromAction(
				"0933e178-369d-4568-98a8-ad983150a93c",
                "Словарь",                
                AppNavigation.ActionFromPage("Section2ListPage"),
				AppNavigation.IconFromGlyph("\ue1d3")));

            NavigationItems.Add(AppNavigation.NodeFromAction(
				"acabd0b0-08c8-48a7-a21b-7c2545e46729",
                "GrooveMusic",                
                AppNavigation.ActionFromPage("GrooveMusicListPage"),
				AppNavigation.IconFromGlyph("\ue189")));
